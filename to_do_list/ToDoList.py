...
#main
Frame_= Frame(root,width=400,height=50,bg="white")
Frame_.place(x=0,y=180)

task=StringVar()
task_entry=Entry(Frame_,width=18,font="arial 20",bd=0)
task_entry.place(x=10,y=7)

button=Button(Frame_,text="ADD",font="arial 20 bold",width=6,bg="#5a95ff",bd=0,command=addTask)
